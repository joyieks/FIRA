...
export const analyzeMessageForFireAlarm = async (messageText) => {
  try {
    console.log('🔍 AI Service: Starting analysis for message:', messageText);
    console.log('🔍 AI Service: API Key available:', !!import.meta.env.VITE_OPENAI_API_KEY);
    
    if (!messageText || messageText.trim() === '') {
      console.log('🔍 AI Service: Empty message, returning null');
      return {
        houses: null,
        high_rise: false,
        area_scale: 'none',
