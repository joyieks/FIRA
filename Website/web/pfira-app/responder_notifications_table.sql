-- Responder Notifications Table for Project FIRA
...
-- INSERT INTO responder_notifications (responder_id, station_id, fire_report_id, title, message, priority)
-- VALUES (
--   'responder-uuid-here',
--   'station-uuid-here', 
--   'fire-report-123',
--   'Fire Alert - Test Location',
--   '🚨 FIRE ALERT from Test Station\n\n📍 Location: Test Address\n🔥 Alarm Level: First Alarm',
--   'high'
-- );
