...
The API endpoint `https://fire-detection-api-production-f8a3.up.railway.app/predict` is returning 404.
...
1. Visit the API URL in browser: `https://fire-detection-api-production-f8a3.up.railway.app/predict`
...
```bash
curl https://fire-detection-api-production-f8a3.up.railway.app/predict
```
